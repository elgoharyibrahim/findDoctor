...
export class DoctorPage implements OnInit {
  ...
  doctor:any;
  destination: any =  {};
  constructor(private geolocation: Geolocation,public alertController: AlertController,public _apiService: ApiService,private route: ActivatedRoute,private urlProvider: UrlProvider, public loadingController: LoadingController,
